import { LanyardActivity, LanyardPresence, StatusData } from "../@types/discord-status.type";
...
export const getPrimaryActivity = (activities: LanyardActivity[] = []): LanyardActivity | null => {
...
export const transformPresence = (presence: LanyardPresence): StatusData => {
