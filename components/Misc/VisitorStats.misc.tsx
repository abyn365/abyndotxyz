    ...
    <div className="absolute -top-3 -left-3 flex items-center gap-2">
      <div className="bg-zinc-900/90 rounded-full px-2 py-1 border border-zinc-800/50 flex items-center gap-1.5">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-[10px] text-zinc-300">{data.active}</span>
        </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-[10px] text-zinc-300">{data.pageviews}</span>
        </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <span className="text-[10px] text-zinc-300">{data.uniques}</span>
        </div>
      </div>
    </div>
  );
