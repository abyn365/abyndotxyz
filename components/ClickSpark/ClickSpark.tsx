  ...
  class ClickSpark extends HTMLElement {
    ...
    private createSpark() {
      return `
        ...
        <svg width="30" height="30" viewBox="0 0 100 100" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" stroke="var(--click-spark-color, #ffffff)" transform="rotate(-20)">
          ${Array.from(
            { length: 8 },
