    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <div className="relative z-10 flex-1 flex flex-col lg:grid lg:grid-cols-12 gap-6 lg:gap-16 w-full max-w-6xl mx-auto px-4 lg:px-6 py-4 lg:py-6 overflow-hidden min-h-0">
            ...
            <div className="shrink-0 flex flex-col gap-4 border-t py-4 px-2 lg:hidden bg-gradient-to-t from-[var(--bg-primary)] to-transparent" style={{ borderColor: "var(--card-border)" }}>
              {/* Progress Slider */}
              <div className="w-full flex flex-col gap-1.5">
                <div className="relative w-full h-1 bg-[var(--card-border)] rounded-full cursor-pointer"
                     onClick={(e) => {
                       const rect = e.currentTarget.getBoundingClientRect();
                       const ratio = (e.clientX - rect.left) / rect.width;
                       seek(ratio * duration);
              ...
              <div className="flex items-center justify-center gap-6">
                ...
                <button
                  onClick={isPlaying ? pause : resume}
                  className="flex h-11 w-11 items-center justify-center rounded-full transition-all hover:scale-105 active:scale-95 text-white"
                  style={{
                    background: `linear-gradient(135deg, ${accent}, ${accentColor.secondary})`,
                  }}
                >
